  ...
  return (
    <div className='sm:w-[80%] sm:mx-auto mx-2 text-gray-800 min-h-screen'>
        ...
        <form onSubmit={handleSubmit} className='sm:w-[40%] flex-col flex gap-2 py-6 px-3 sm:mx-auto mx-2 rounded-2xl bg-[#f5f2f0]'>
             ...
             <p className='text-2xl font-semibold text-center sm:mt-[20] mb-10'>Add New Products</p>
            ...
            <label>
              ...
              <label>
                <p>Products countaty</p>
                <input type='number' name='countaty' onChange={handleChange} value={data.countaty} className='input w-full' required />
            </label>
