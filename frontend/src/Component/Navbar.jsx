        ...
        <nav className='bg-[#f5f2f0] w-full fixed top-0'>
            ...
            <div className='flex sm:h-20 h-16 sm:[80%] sm:mx-auto mx-1 justify-around items-center'>
                ...
                <div className={`flex sm:gap-8 gap-2 items-center`} >
                    ...
                    {token === "" ? <Link to='/singin' className='sm:px-3 py-1 px-2  bg-blue-500 hover:bg-blue-600 text-white rounded-lg cursor-pointer'>Login</Link> :
                        <FaUser className='cursor-pointer sm:h-8 sm:w-8 h-6 w-6' />}
                </div>
